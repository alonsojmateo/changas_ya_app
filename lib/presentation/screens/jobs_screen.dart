...
class _JobScreenState extends ConsumerState<JobsScreen> {
  ...
  Future<void> _loadInitialData() async {
    ...
    _pageCursors.clear();
    await notifier.getAvailableJobsForWorkers();
  ...
  Future<void> _loadNextPage() async {
    ...
    await ref.read(jobProvider.notifier).getAvailableJobsForWorkers(
  ...
  Future<void> _loadPreviousPage() async {
    ...
    final notifier = ref.read(jobProvider.notifier);
    await notifier.getAvailableJobsForWorkers(startAfterDoc: cursor);
